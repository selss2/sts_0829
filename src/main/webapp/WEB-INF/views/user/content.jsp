...
<link rel="stylesheet" type="text/css"
	href="${css}/font/font-awesome-4.1.0/css/font-awesome.min.css">
<link rel="stylesheet" type="text/css"
	href="${css}/font/eleganticons/et-icons.css">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="team text-center">
					...
					<img src="${img}/team/team_bears.png" alt="Team Image"
						class="avatar">
					<div class="title">
						<h4>수강과목1</h4>
			...
			<div class="col-md-4">
				<div class="team text-center">
					...
					<img src="${img}/team/team_tigers.jpg" alt="Team Image"
						class="avatar">
					<div class="title">
						<h4>수강과목2</h4>
			...
			<div class="col-md-4">
				<div class="team text-center">
					...
					<img src="${img}/team/team_twins.png" alt="Team Image"
						class="avatar">
					<div class="title">
						<h4>수강과목3</h4>
...
$(function() {
$('#user_content #kaup').addClass('cursor').click(function(){
	controller.move('member','kaup');
	});
$('#user_content #rock_sissor_paper').addClass('cursor').click(function(){
	controller.move('member','rock_sissor_paper');
	});
$('#user_content #lotto').addClass('cursor').click(function(){
